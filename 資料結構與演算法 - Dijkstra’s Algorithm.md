...
## 要解決的問題
用來在沒有方向性的graph中，給一個節點，找到通往其他所有節點的成本最小路徑(least-cost path)。
在生活中應用很廣，例如：電線、油管、人行道鋪設、網路線。

## 步驟
![](https://i.imgur.com/KwCzIut.png)

1. 給定一個節點作為初始節點
2. graph上每個節點到初始節點的距離設置為無限大
